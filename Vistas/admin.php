            ...
            <div class="col-md-3">
                <h3>Ingresar nueva mascota</h3>
                    <form action='../CRUD/insertar.php' method="POST">
                        <input type="text" class="form-control mb-3" name="ID_mascota" placeholder="ID de mascota" required>
                        <input type="text" class="form-control mb-3" name="Especie" placeholder="Especie" required>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <th><a href="actualizar_pag.php?id=<?php echo $row['ID'] ?>" class="btn btn-info">Editar</a></th>
                                <th><a href="../CRUD/eliminar.php?id=<?php echo $row['ID'] ?>" class="btn btn-danger">Eliminar</a></th> 
                            </tr>
                        <?php 
                            }
                        ?>
